...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    //默认色
    private int mDefaultColor = 0xffdab866;
...
//        getDialog().getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL);
        ...
        lp.width = (int) (displayMetrics.widthPixels * 0.75f);
...
//        return inflater.inflate(R.layout.lib_update_app_dialog, container);
        return inflater.inflate(R.layout.custom_dialogg, container);
    }
...
//        btn_cancel.setBackgroundDrawable(DrawableUtil.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), color));
